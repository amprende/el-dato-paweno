...
// Cargar ofertas personalizadas y filtradas de localStorage
...
// Aplicar ofertas personalizadas
DEALS_DATA.unshift(...customDeals);

// Filtrar ofertas eliminadas
const filteredDeals = DEALS_DATA.filter(deal => !deletedDeals.includes(deal.id));
DEALS_DATA.length = 0;
DEALS_DATA.push(...filteredDeals);
